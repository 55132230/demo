!function(root, factory) {
    "object" == typeof exports && "object" == typeof module ? module.exports = factory(require("prop-types"), require("react"), require("lodash.isequal"), require("react-dnd"), require("react-dnd-html5-backend"), require("react-dnd-scrollzone"), require("react-dom"), require("react-virtualized")) : "function" == typeof define && define.amd ? define([ "prop-types", "react", "lodash.isequal", "react-dnd", "react-dnd-html5-backend", "react-dnd-scrollzone", "react-dom", "react-virtualized" ], factory) : "object" == typeof exports ? exports.ReactSortableTree = factory(require("prop-types"), require("react"), require("lodash.isequal"), require("react-dnd"), require("react-dnd-html5-backend"), require("react-dnd-scrollzone"), require("react-dom"), require("react-virtualized")) : root.ReactSortableTree = factory(root["prop-types"], root.react, root["lodash.isequal"], root["react-dnd"], root["react-dnd-html5-backend"], root["react-dnd-scrollzone"], root["react-dom"], root["react-virtualized"]);
}(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_25__, __WEBPACK_EXTERNAL_MODULE_26__, __WEBPACK_EXTERNAL_MODULE_27__, __WEBPACK_EXTERNAL_MODULE_28__) {
    /******/
    ...
    function(module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", {
            value: !0
        }), exports.SortableTreeWithoutDndContext = exports.dndWrapExternalSource = void 0;
        ...
        var _dragAndDropUtils = __webpack_require__(7);
        Object.defineProperty(exports, "dndWrapExternalSource", {
            enumerable: !0,
            get: function() {
                return _dragAndDropUtils.dndWrapExternalSource;
            }
        });
        var _reactSortableTree = __webpack_require__(10), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree);
    ...
    function(module, exports, __webpack_require__) {
        ...
        function addStyle(obj, options) {
            ...
            if (options.transform && obj.css) {
                if (result = options.transform(obj.css), !result) // If the transform function returns a falsy value, don't add this css.
	...
	*/
        ...
        }), singleton = null, singletonCounter = 0, stylesInsertedAtTop = [], fixUrls = __webpack_require__(22);
    ...
    function(module, exports, __webpack_require__) {
        ...
        function getTargetDepth(dropTargetProps, monitor, component) {
            ...
            if ("rst__NewItem" === monitor.getItem().type) // Add new node from external source
            if (component) {
        ...
        function canDrop(dropTargetProps, monitor, component) {
            ...
            var rowAbove = dropTargetProps.getPrevRow(), abovePath = rowAbove ? rowAbove.path : [], aboveNode = rowAbove ? rowAbove.node : {}, targetDepth = getTargetDepth(dropTargetProps, monitor, component);
        ...
        function dndWrapExternalSource(UserComponent, type) {
            var DndWrapExternalSource = function(_React$Component) {
                function DndWrapExternalSource() {
                    return _classCallCheck(this, DndWrapExternalSource), _possibleConstructorReturn(this, (DndWrapExternalSource.__proto__ || Object.getPrototypeOf(DndWrapExternalSource)).apply(this, arguments));
                }
                return _inherits(DndWrapExternalSource, _React$Component), _createClass(DndWrapExternalSource, [ {
                    key: "render",
                    value: function() {
                        return this.props.connectDragSource(_react2.default.createElement("div", null, _react2.default.createElement(UserComponent, this.props)), {
                            dropEffect: "copy"
                        });
                    }
            ...
            return DndWrapExternalSource.defaultProps = {
                dropCanceled: function() {
                ...
                dropCanceled: _propTypes2.default.func.isRequired,
                addNewItem: _propTypes2.default.func.isRequired
            }, (0, _reactDnd.DragSource)(type, externalSource, externalSourcePropInjection)(DndWrapExternalSource);
        }
        ...
        exports.dndWrapExternalSource = dndWrapExternalSource, exports.dndWrapSource = dndWrapSource, 
        exports.dndWrapTarget = dndWrapTarget, exports.dndWrapRoot = dndWrapRoot;
        var _reactDnd = __webpack_require__(24), _reactDndHtml5Backend = __webpack_require__(25), _reactDndHtml5Backend2 = _interopRequireDefault(_reactDndHtml5Backend), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _reactDom = __webpack_require__(27), _treeDataUtils = __webpack_require__(1), _memoizedTreeDataUtils = __webpack_require__(8), nodeDragSource = {
            ...
            endDrag: function(props, monitor) {
                monitor.didDrop() ? props.addNewItem(monitor.getDropResult()) : props.dropCancelled();
            }
        }, nodeDropTarget = {
            ...
            hover: function(dropTargetProps, monitor, component) {
                var targetDepth = getTargetDepth(dropTargetProps, monitor, component), draggedNode = monitor.getItem().node, needsRedraw = // Redraw if hovered above different nodes
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _createClass = function() {
            ...
            return target;
        }, _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _browserUtils = __webpack_require__(12), _nodeRendererDefault = __webpack_require__(19), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), styles = _nodeRendererDefault2.default;
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(4), _propTypes2 = _interopRequireDefault(_propTypes), _reactVirtualized = __webpack_require__(28), _lodash = __webpack_require__(23), _lodash2 = _interopRequireDefault(_lodash), _reactDndScrollzone = __webpack_require__(26), _reactDndScrollzone2 = _interopRequireDefault(_reactDndScrollzone);
        __webpack_require__(18);
        var _treeNode = __webpack_require__(11), _treeNode2 = _interopRequireDefault(_treeNode), _nodeRendererDefault = __webpack_require__(9), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), _memoizedTreeDataUtils = __webpack_require__(8), _genericUtils = __webpack_require__(13), _defaultHandlers = __webpack_require__(6), _dragAndDropUtils = __webpack_require__(7), _reactSortableTree = __webpack_require__(20), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree), dndTypeCounter = 1, ReactSortableTree = function(_Component) {
            function ReactSortableTree(props) {
                ...
                return _this.dndType = dndType || "rst__" + dndTypeCounter, dndTypeCounter += 1, 
            ...
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function() {
                    ...
                    onChange(expandedTreeData)), console.log("ctodo((((varName2))))"), // eslint-disable-line no-console
                    searchFinishCallback && searchFinishCallback(searchMatches);
                ...
                key: "renderRow",
                value: function(_ref9, listIndex, style, getPrevRow, matchKeys) {
                    var node = _ref9.node, parentNode = _ref9.parentNode, path = _ref9.path, lowerSiblingCounts = _ref9.lowerSiblingCounts, treeIndex = _ref9.treeIndex, _props = this.props, canDrag = _props.canDrag, canDrop = _props.canDrop, generateNodeProps = _props.generateNodeProps, getNodeKey = _props.getNodeKey, maxDepth = _props.maxDepth, scaffoldBlockPxWidth = _props.scaffoldBlockPxWidth, searchFocusOffset = _props.searchFocusOffset, TreeNodeRenderer = this.treeNodeRenderer, NodeContentRenderer = this.nodeContentRenderer, nodeKey = path[path.length - 1], isSearchMatch = nodeKey in matchKeys, isSearchFocus = isSearchMatch && matchKeys[nodeKey] === searchFocusOffset, callbackParams = {
                        node: node,
                        parentNode: parentNode,
                        path: path,
                        lowerSiblingCounts: lowerSiblingCounts,
                ...
                value: function() {
                    ...
                    if (isVirtualized) {
                        ...
                        list = _react2.default.createElement(_reactVirtualized.AutoSizer, null, function(_ref11) {
                            var height = _ref11.height, width = _ref11.width;
                            return _react2.default.createElement(ScrollZoneVirtualList, _extends({}, scrollToInfo, {
                                ...
                                rowHeight: rowHeight,
                                rowRenderer: function(_ref13) {
                                    var index = _ref13.index, rowStyle = _ref13.style;
    ...
    function(module, exports, __webpack_require__) {
        ...
        TreeNode.defaultProps = {
            ...
            // used in drag-and-drop-utils
            getNodeKey: _propTypes2.default.func.isRequired,
            // used in drag-and-drop-utils
    ...
    function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__(2)(void 0), // imports
        // module
        exports.push([ module.id, ".rst__tree{/*! This comment keeps Sass from deleting the empty rule */}.rst__virtualScrollOverride{overflow:auto!important}.rst__virtualScrollOverride *{-webkit-box-sizing:border-box;box-sizing:border-box}.ReactVirtualized__Grid__innerScrollContainer{overflow:visible!important}.ReactVirtualized__Grid{outline:none}", "" ]), 
        // exports
        exports.locals = {
            tree: "rst__tree",
